...
Перед сменой провайдера, модели или prompt необходимо прогнать общий eval-набор
и сравнить результат с baseline. Формат запуска, метрики и команды описаны в
[`assistant-evals.md`](assistant-evals.md).
