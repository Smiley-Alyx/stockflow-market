...
1. **Подключить Alertmanager и воспроизводимые failure drills.** Настроить
...
2. **Добавить eval-набор для AI-ассистента.** Зафиксировать пользовательские
...
3. **Повторить нагрузочный baseline на реалистичном каталоге.** Подготовить
